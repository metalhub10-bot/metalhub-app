      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
          ...
          <View style={styles.guestCard}>
            <Text style={styles.guestText}>Inicia sesión para ver tu perfil y publicar ofertas.</Text>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsCard}>
          ...
          <View style={styles.stat}>
            ...
            <Text style={styles.statValue}>{user.miembroDesde ?? new Date().getFullYear()}</Text>
...
const styles = StyleSheet.create({
  ...
  guestCard: { backgroundColor: colors.card, borderRadius: borderRadius.lg, padding: spacing.lg, borderWidth: 1, borderColor: colors.border },
  guestText: { color: colors.textSecondary, marginBottom: spacing.md, textAlign: 'center' },
  loginBtn: { backgroundColor: colors.primary, paddingVertical: spacing.md, borderRadius: borderRadius.md, alignItems: 'center' },
  loginBtnText: { color: '#0D0D0F', fontWeight: '700' },
  profileCard: { alignItems: 'center', marginBottom: spacing.lg },
  avatarWrap: { position: 'relative', marginBottom: spacing.sm },
  avatar: { width: 88, height: 88, borderRadius: 44, backgroundColor: colors.cardElevated, borderWidth: 3, borderColor: colors.primary },
  ...
  userName: { fontSize: 22, fontWeight: '700', color: colors.text, marginBottom: spacing.sm },
  badges: { flexDirection: 'row', gap: spacing.sm, marginBottom: spacing.sm },
  badgeRole: { backgroundColor: colors.primary, paddingHorizontal: spacing.md, paddingVertical: 4, borderRadius: borderRadius.sm },
  badgeRoleText: { color: '#0D0D0F', fontSize: 12, fontWeight: '600' },
  badgeVerified: { flexDirection: 'row', alignItems: 'center', gap: 4, borderWidth: 1, borderColor: colors.info, paddingHorizontal: spacing.sm, paddingVertical: 4, borderRadius: borderRadius.sm },
  badgeVerifiedText: { color: colors.text, fontSize: 12 },
  bio: { color: colors.textSecondary, fontSize: 14, marginBottom: 2, textAlign: 'center' },
  statsCard: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: colors.card, borderRadius: borderRadius.lg, padding: spacing.lg, marginBottom: spacing.sm, borderWidth: 1, borderColor: colors.border },
  ...
  sectionLabel: { fontSize: 11, fontWeight: '600', letterSpacing: 0.5, color: colors.textSecondary, marginBottom: spacing.sm },
  menuItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, paddingHorizontal: spacing.md, paddingVertical: spacing.md, borderRadius: borderRadius.md, marginBottom: spacing.sm, gap: spacing.sm, borderWidth: 1, borderColor: colors.border },
