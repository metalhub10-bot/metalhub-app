...
import { View, Text, TextInput, StyleSheet, TouchableOpacity, KeyboardAvoidingView, Platform, ScrollView, Alert, ActivityIndicator, Image } from 'react-native';
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (res.sessionId) {
        ...
        // Una vez que tenemos sesión, registramos el token de push en el backend
