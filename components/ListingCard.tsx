        ...
        <View style={styles.userRow}>
          ...
          <View style={styles.userInfo}>
            <View style={styles.nameRow}>
              ...
              {verified && <Ionicons name="checkmark-circle" size={16} color={colors.info} />}
            </View>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 32, height: 32, borderRadius: 16, backgroundColor: colors.borderLight, marginRight: spacing.sm },
  userInfo: { flex: 1 },
